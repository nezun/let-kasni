...
function srAirlineDelaySections(article: BlogArticle): BlogSection[] {
  ...
  return [
    {
      heading: `${article.sr.title}: podaci leta i vremenska linija`,
      body: [
...
function enAirlineDelaySections(article: BlogArticle): BlogSection[] {
  ...
  return [
    {
      heading: `${article.en.title}: flight data and timeline`,
      body: [
...
function srDelayScenarioSections(article: BlogArticle): BlogSection[] {
  ...
  return [
    {
      heading: `${article.sr.title}: ruta, dolazak i dokaz`,
      body: [
...
function enDelayScenarioSections(article: BlogArticle): BlogSection[] {
  ...
  return [
    {
      heading: `${article.en.title}: route, arrival and evidence`,
      body: [
...
function srEnhancementSections(article: BlogArticle): BlogSection[] {
  ...
  return [
    {
      heading: `${article.sr.title}: ruta, vreme i odgovornost aviokompanije`,
      body: [
    ...
    {
      heading: `${article.sr.title}: dokumenti koje Let Kasni proverava`,
      body: [
    ...
    {
      heading: `${article.sr.title}: odgovor na odbijanje aviokompanije`,
      body: [
...
function enEnhancementSections(article: BlogArticle): BlogSection[] {
  ...
  return [
    {
      heading: `${article.en.title}: route, timing and airline responsibility`,
      body: [
    ...
    {
      heading: `${article.en.title}: documents Let Kasni reviews`,
      body: [
    ...
    {
      heading: `${article.en.title}: response to airline rejection`,
      body: [
